...
def getLastData():
    ...
    connR = psycopg2.connect("dbname=mydb user=postgres password=postgres host=mydb-service port=5432")
    ...
    #DATABASE_URL = os.environ['DATABASE_URL']
    #onnL = psycopg2.connect(DATABASE_URL, sslmode='require')
    connL = psycopg2.connect("dbname=mydb user=postgres password=postgres host=mydb-service port=5432")
